...
export default class Box4 extends React.Component {
  ...
  constructor(props) {
    ...
    this.state = {
      value: 'https://so.link/networkvideo',
      copied: false,
    }
  }
            ...
            <Grid container spacing={1}>
              ...
              <Grid item xs={12} md>
                <select className="card-button-text custom-select custom-select-lg" onChange={this.onSelect}>
                  <option value="https://so.link/networkvideo">English</option>
                  <option value="https://so.link/networkvideo-german">German</option>
                  <option value="https://so.link/networkvideo-french">French</option>
                  <option value="https://so.link/networkvideo-thai">Thai</option>
                  <option value="https://so.link/networkvideo-vietnamese">Vietnamese</option>
                </select>
              </Grid>
              <Grid item xs={12} md>
